...
export OMP_NUM_THREADS=32 #OMP_NUM_THREADS should be set to same number as --CPU parameter
...
Trinity --seqType fq --max_memory 100G --left /scratch/TrinityB1/B1_trinity/B1_1_cutadapted.fq.gz --right /scratch/TrinityB1/B1_trinity/B1_2cutadapted.fq.gz --SS_lib_type FR --CPU 32 --min_contig_length 200 --full_cleanup --verbose --output /scratch/TrinityB1/B1_trinity
